  ...
  <p className="text-base sm:text-lg md:text-xl text-white max-w-lg mx-auto md:mx-0">
    Experience effortless recovery and relief with Lost and Found
        ...
        <div className="flex flex-col w-full md:w-1/2 mt-[100px] justify-center items-center gap-5">
          ...
          <a href="/found">
            <Button className="flex items-center justify-center gap-x-4 px-6 py-4 sm:px-10 sm:py-6 w-40 sm:w-48 bg-gradient-to-r from-green-500 to-green-300 text-lg sm:text-xl hover:bg-white hover:text-gray-800">
              <span>Found</span>
          ...
          <a href="/search">
            <Button className="flex items-center justify-center gap-x-4 px-6 py-4 sm:px-10 sm:py-6 w-40 sm:w-48 bg-gradient-to-r from-gray-500 to-gray-300 text-lg sm:text-xl hover:bg-white hover:text-gray-800">
              <span>Search</span>
      ...
      <motion.section
        ...
        className="w-full px-4 md:px-16 py-16 flex justify-center"
      >
        <PostedNumber />
      </motion.section>
      <motion.section
        ...
        transition={{ duration: 0.6, ease: "easeOut" }}
        viewport={{ once: true, amount: 0.3 }}
        className="w-full px-4 md:px-16 py-12 flex justify-center"
      >
        <HomeCards />
      </motion.section>
