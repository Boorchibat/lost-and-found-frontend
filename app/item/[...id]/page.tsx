...
export default function ItemDetailPage({ params }: PageProps) {
  ...
  if (error)
    return <div className="text-center bg-gradient-to-r from-yellow-500 to-blue-400 mt-10 text-red-500">{error}</div>;
  if (!item) return <div className="text-center bg-gradient-to-r from-yellow-500 to-blue-400 mt-10">Item not found</div>;
